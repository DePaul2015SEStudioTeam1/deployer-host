...
/**
 * Special {@link com.github.dockerjava.api.command.DockerCmdExecFactory} implementation that collects container and image creations
 * while test execution for the purpose of automatically cleanup.
 *
 * @author marcus
 *
 */
public class HostDockerCmdExecFactory implements DockerCmdExecFactory {
	...
	public HostDockerCmdExecFactory(DockerCmdExecFactory delegate) {
